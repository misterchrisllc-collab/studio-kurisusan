...
const SECTIONS: Section[] = [
  ...
  {
    title: "個人の信頼を仕事につなげる",
    outcome: "経営者・専門職のプロフィールとブランディング撮影",
    rows: [
      {
        name: "プロフィール撮影",
        desc: "HP・SNS・名刺用。1ロケ・1〜2衣装で。",
        price: "¥35,000〜",
        use: "コーポレートサイト・SNS・名刺・登壇資料",
        delivery: "10カット〜（表情・角度違い）色補正込み",
        shootTime: "約1時間",
        leadTime: "3〜5営業日",
        options: "衣装追加・ヘアメイク手配・スタジオ利用",
      },
      {
        name: "パーソナルブランディング撮影",
        desc: "働く姿も、人柄も。複数シーンで撮り分け。",
        price: "¥65,000〜",
        use: "HP・SNS・取材対応・プロフィール一新",
        delivery: "25カット〜（ポートレート・仕事風景・ディテール）",
        shootTime: "約半日",
        leadTime: "5〜7営業日",
        options: "ロケ地追加・動画・SNS用の縦型カット",
      },
      {
        name: "エディトリアル撮影",
        desc: "出版・講演・メディア取材に。1日かけて撮り下ろし。",
        price: "¥95,000〜",
        use: "書籍・雑誌・講演資料・プレスリリース",
        delivery: "複数ロケーション 40カット〜＋短尺動画",
        shootTime: "1日",
        leadTime: "7〜10営業日",
        options: "ヘアメイク・スタイリスト手配・動画本数の追加",
      },
    ],
  },
  {
